...
def add_arguments(parser):
    ...
    #
    # # # datah
    # # # parser.add_argument("D:/Programfile/py-object/fsauor2018-master/scripts/data/train.json", type=str, nargs='+', default=None, help="data file for train or inference")
    # # # parser.add_argument("D:/Programfile/py-object/fsauor2018-master/scripts/data/validation.json", type=str, nargs='+', default=None, help="eval data file for evaluation")
    # # # parser.add_argument("D:/Programfile/py-object/fsauor2018-master/scripts/data/labels.txt", type=str, default=None, help="label file")
    # # # parser.add_argument("D:/Programfile/py-object/fsauor2018-master/scripts/data/vocab.txt", type=str, default=None, help="vocab file")
    # # # parser.add_argument("D:/Programfile/py-object/fsauor2018-master/scripts/data/embedding.txt", type=str, default=None, help="embedding file to restore")
    # # # parser.add_argument("D:/Programfile/py-object/fsauor2018-master/scripts/data/out.testa.json", type=str, default=None, help="output file for inference")
    ...
    parser.add_argument("--data_files", type=str, nargs='+',
                        default=None, help="data file for train or inference")
    parser.add_argument("--eval_files", type=str, nargs='+',
                        default=None, help="eval data file for evaluation")
    parser.add_argument("--label_file", type=str, default=None,
                        help="label file")
    parser.add_argument("--vocab_file", type=str, default=None,
                        help="vocab file")
    parser.add_argument("--embed_file", type=str, default=None,
                        help="embedding file to restore")
    parser.add_argument("--out_file", type=str,
                        default=None, help="output file for inference")
    parser.add_argument("--split_word", type='bool', nargs="?", const=True, default=True,
                        help="Whether to split word when oov")
    parser.add_argument("--max_len", type=int, default=232, help='max length for doc')#, default=1200
    parser.add_argument("--batch_size", type=int, default=32, help="batch size")
    parser.add_argument("--reverse", type='bool', nargs="?", const=True, default=False, help="Whether to reverse data")
    parser.add_argument("--prob", type='bool', nargs="?", const=True, default=False, help="Whether to export prob")
    ...
    parser.add_argument("--num_units", type=int, default=300, help="num_units")#lstm输出维度
    ...
    parser.add_argument("--num_train_epoch", type=int, default=50, help="training epoches")#, default=50
    ...
    # parser.add_argument("D:/Programfile/py-object/fsauor2018-master/scripts/data/elmo_ema_0120", type=str, default='/tmp/visual-semantic', help="checkpoint dir to save model")
    parser.add_argument("--checkpoint_dir", type=str,
                        default='/tmp/visual-semantic', help="checkpoint dir to save model")
    print(parser)
    ...
    #
    # # model
    # parser.add_argument(num_layers, default=2, help="number of layers")#, type=int
    # parser.add_argument('hand', type=str, default='hand', help='learning rate decay: exp | hand')
    # parser.add_argument(encoder, type=str, default='gnmt', help="gnmt | elmo")
    # parser.add_argument(10000, type=int, default=10000, help="decay steps")
    # parser.add_argument(learning_rate, type=float, default=0.001, help="Learning rate. RMS: 0.001 | 0.0001")
    # parser.add_argument(focal_loss, type=float, default=2., help="gamma of focal loss")
    # parser.add_argument(0.1, type=float, default=0.1, help="embedding_dropout")
    # parser.add_argument(5.0, type=float, default=5.0, help="Clip gradients to this norm.")
    # parser.add_argument(0.8, type=float, default=0.8, help="drop out keep ratio for training")
    # parser.add_argument(0.8, type=float, default=0.8, help="weight keep drop")
    # parser.add_argument(0.0, type=float, default=0.0, help="l2 loss ratio")
    # parser.add_argument(rnn_cell_name, type=str, default='lstm', help='rnn cell name')
    # parser.add_argument(300, type=int, default=300, help="embedding_size")
    # parser.add_argument(300, type=int, default=300, help="num_units")
    # parser.add_argument(True, type='bool', nargs="?", const=True, default=False,help="Whether to double decoder size")
    # parser.add_argument(True, type='bool', nargs="?", const=True, default=True,help="Whether to use variational_dropout")
    #
    # # clf
    # # parser.add_argument(target_label_num, type=int, default=4, help="target_label_num")
    # parser.add_argument(feature_num , default=20, help="feature_num")#, type=int
    #
    # # train
    # parser.add_argument(True, type='bool', nargs="?", const=True, default=True,help="Whether to early stop")
    # parser.add_argument(5 , default=5, help="patient of early stop")#, type=int
    # parser.add_argument(False, type='bool', nargs="?", const=True, default=False, help="Whether use debug mode")
    # parser.add_argument(50 , default=50, help="training epoches")#, type=int
    # parser.add_argument(20 , default=20, help="steps to print stats")#, type=int
    # parser.add_argument(50 , default=50, help="steps to save summary")#, type=int
    # parser.add_argument(steps_per_eval , default=2000, help="steps to save model")#, type=int
    #
    # # parser.add_argument("D:/Programfile/py-object/fsauor2018-master/scripts/data/elmo_ema_0120", type=str, default='/tmp/visual-semantic', help="checkpoint dir to save model")
    # parser.add_argument(checkpoint_dir, type=str,
    #                     default='/tmp/visual-semantic', help="checkpoint dir to save model")
...
def inference(flags):
    ...
    hparams = load_hparams(flags.checkpoint_dir,{"mode":'inference','checkpoint_dir':flags.checkpoint_dir+"/best_eval",'embed_file':flags.embed_file})
    ...
    with open(flags.out_file,'w',encoding='utf-8') as f:
        ...
        for i,(source, lengths, targets, _) in enumerate(dataset.get_next()):
            ...
            if global_step % flags.steps_per_eval == 0:
                ...
                with tf.Session(graph=eval_graph, config=get_config_proto(log_device_placement=False)) as eval_sess:
                    ...
                    eval_ppl, eval_loss = train_eval_clf(eval_model, eval_sess, eval_dataset)#return -1 * final_f1【在20个指标上的平均loss】, checkpoint_loss/i
                    ...
                    if eval_ppl < best_eval:#best_eval = 1000000000 要改吗
                        pre_best_checkpoint = checkpoint_path
                        eval_model.save_model(eval_sess,global_step)
                        best_eval = eval_ppl
                    eval_ppls.append(eval_ppl)# 验证集上损失率的合集
                if flags.need_early_stop:
                    if early_stop(eval_ppls, flags.patient):# 验证损失率合集，5
                        ...
                        lr = tf.assign(train_model.learning_rate, current_lr/10)#降一次学习率
                        if final_learn==0:#为什么要有=0的时候，还要计算？？
                            dropout = tf.assign(train_model.dropout_keep_prob, 1.0)#为什么要全丢弃
...
# learning_rate=0.001
# focal_loss=0.0
# checkpoint_dir='D:/Programfile/py-object/fsauor2018-master/scripts/data/elmo_ema_0120'
